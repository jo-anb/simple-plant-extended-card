...
Simple Plant Extended Card is a custom dashboard card for the [Simple Plant integration](https://github.com/jo-anb/simple-plant)
...
For any issue regarding this custom card, please report it in [the main repository](https://github.com/jo-anb/simple-plant).
